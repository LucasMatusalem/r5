...
<template>
  <div class="space-y-4">
    <DataTableToolbar :table="table" :table-cfg="props.tableCfg" v-if="props.tableCfg.options.showFilters" />
    ...
    <DataTablePagination :table="table" v-if="props.tableCfg.options.showPagination" />
  </div>
</template>
